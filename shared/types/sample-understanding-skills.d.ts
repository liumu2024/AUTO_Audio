...
export type ShotType = 'close_up' | 'medium' | 'wide' | 'top_view' | 'macro' | string;
...
export type MotionType = 'push_in' | 'pull_out' | 'pan_left' | 'pan_right' | 'shake' | 'static' | string;
...
export type EmotionType = 'excited' | 'calm' | 'surprised' | 'urgent' | 'happy' | string;
...
export type SkillName = 'asr' | 'ocr' | 'vision' | 'motion' | 'rhythm' | 'emotion';
...
//# sourceMappingURL=sample-understanding-skills.d.ts.map