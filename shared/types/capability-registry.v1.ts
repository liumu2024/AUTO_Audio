...
export const CAPABILITY_LAYER_KINDS = [
  ...
  'audio_driver',
  'composite',
] as const satisfies readonly CapabilityLayerKind[]
...
export type CapabilitySupportValue =
  | string
  | number
  | boolean
  | string[]
  | number[]
  | CapabilitySupportRange
...
export type CapabilityAcceptedAssetType =
  | 'image'
  | 'video'
  | 'generated_video'
  | 'audio'
...
export function isOverlayCapability(manifest: CapabilityPluginManifest): boolean {
