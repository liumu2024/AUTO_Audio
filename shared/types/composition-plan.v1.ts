...
export const COMPOSITION_PLAN_SCHEMA_VERSION = 'composition_plan.v1' as const
export const COMPOSITION_VALIDATION_SCHEMA_VERSION = 'composition_validation.v1' as const

export type CompositionStatusKind =
  | 'complete'
  | 'auto_repaired'
  | 'missing_capability'
  | 'invalid'
...
export type CompositionRepairActionKind =
  | 'add_layer'
  | 'ask_user'
  | 'generate_plugin'
  | 'none'
