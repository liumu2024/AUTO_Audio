export const REMOTION_TIMELINE_SPEC_SCHEMA_VERSION = 'remotion_timeline_spec.v1' as const

export type RemotionTimelineAssetType = 'video' | 'image' | 'audio'
export type RemotionTimelineAssetSource =
  | 'user_asset'
  | 'generated_asset'
  | 'stock_asset'
  | 'local_fixture'
...
export type RemotionTimelineSceneType =
  | 'user_video'
  | 'ai_video'
  | 'image_motion'
  | 'remotion_card'
...
export type RemotionTimelineOverlayAnimation =
  | 'none'
  | 'fade'
  | 'slide_up_fade'
  | 'pop'
