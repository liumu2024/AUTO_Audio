...
export type AssetVisualTag = 'face' | 'product' | 'close_up' | 'wide_shot' | 'empty_scene' | 'screen_recording' | 'food' | 'lifestyle' | string;
export type AssetEmotionTag = 'excited' | 'calm' | 'surprised' | 'urgent' | 'happy' | 'trustworthy' | string;
...
//# sourceMappingURL=asset-analysis.v1.d.ts.map