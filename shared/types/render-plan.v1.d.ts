import type { SequenceSpec, TimelineTransition, VisualMotion } from './migration-protocol.v1.2.js';
import type { CapabilityLayerKind } from './capability-registry.v1.js';
import type { SceneCompositionStatus } from './composition-plan.v1.js';
import type { MotifSharedGeometry, MotifSharedTimeline } from './effect-roadmap.v1.js';
export type { CapabilityLayerKind };
export type RenderStrategy = 'montage' | 'motion_graphics' | 'hybrid';
export type RenderAssetType = 'video' | 'image' | 'audio' | 'generated_video';
export type RenderSceneRole = 'hook' | 'pain' | 'demo' | 'proof' | 'cta' | 'transition' | string;
export type VisualMode = 'material_clip' | 'ai_generated' | 'image_motion' | 'solid_bg';
export type OverlayType = 'subtitle' | 'big_caption' | 'sticker' | 'alert_box' | 'price_tag' | 'cta';
export type AudioLayerType = 'bgm' | 'sfx' | 'voiceover';
...
export interface VisualLayer {
    ...
    motion?: {
        ...
        intensity: number;
        easing?: VisualMotion['easing'];
        driver?: VisualMotion['driver'];
    };
...
export type SceneEffects = ColorPortalSpotlightEffects | PrimitiveColorTransformEffects | PrimitiveMaskRevealEffects | PrimitiveRingOverlayEffects | PrimitiveOrbMotionEffects | PrimitiveOrbRingOverlayEffects | PrimitiveDirectionalWaveRevealEffects | PrimitiveTextureGradeEffects | PrimitiveBloomOverlayEffects | PrimitiveVignetteOverlayEffects | PrimitiveGrainOverlayEffects | PrimitiveLetterboxOverlayEffects | PrimitiveChromaticAberrationOverlayEffects | PrimitiveLightSweepOverlayEffects | PrimitiveBeatPulseEffects | PrimitiveBeatFlashOverlayEffects | PrimitiveBeatColorUnlockEffects | PrimitiveColorHintOverlayEffects | PrimitiveFadeOverlayEffects | PrimitiveTransitionAccentOverlayEffects | PrimitiveSliceRevealEffects | PrimitiveRippleDisplacementEffects | PrimitiveRippleRingOverlayEffects | PrimitiveCollageLayoutEffects | CinematicLightSweepEffects | RippleDisplacementEffects | KineticColorRippleEffects | EditorialSplitCollageEffects | CinematicGradePackEffects | AudioReactiveCutDriverEffects | MaskSliceTransitionEffects | GeneratedComponentEffects;
export interface RenderPlanComponentResolutionDecision {
...
export interface RenderPlanComponentResolution {
    enabled: boolean;
    authoring_enabled: boolean;
    decisions: RenderPlanComponentResolutionDecision[];
    debug_dir?: string;
}
/** @deprecated use CapabilityLayerKind from capability-registry.v1 */
...
export interface RenderSceneEffectBinding {
    sharedParams?: Record<string, {
...
export interface RenderScene {
    ...
    /** Cross-layer shared bindings compiled from EffectRoadmap (params, timeline, geometry). */
    effect_binding?: RenderSceneEffectBinding;
    /** Effect composition validator output for UI. */
    composition_status?: SceneCompositionStatus;
...
export interface RenderPlanV1 {
    ...
    assets: RenderAsset[];
    component_resolution?: RenderPlanComponentResolution;
}
...
//# sourceMappingURL=render-plan.v1.d.ts.map