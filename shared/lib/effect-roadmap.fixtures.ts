...
export const validKineticOrbRevealRoadmapFixture: EffectRoadmap = {
...
export const validColorPortalUnlockRoadmapFixture: EffectRoadmap = {
  schema_version: 'effect_roadmap.v1',
...
export const validLayoutCollageRoadmapFixture: EffectRoadmap = {
  schema_version: 'effect_roadmap.v1',
