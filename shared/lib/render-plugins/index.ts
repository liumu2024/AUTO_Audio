...
export const RENDER_PLUGIN_LAYER_BUCKETS: RenderPluginLayerBucket[] = [
  {
...
export const LAYERED_RENDER_PLUGIN_MANIFESTS: CapabilityPluginManifest[] =
  RENDER_PLUGIN_LAYER_BUCKETS.flatMap((bucket) => bucket.plugins)
