...
export const DEFAULT_COLOR_PORTAL_EFFECT: ColorPortalSpotlightEffects = {
...
export const DEFAULT_PRIMITIVE_COLOR_TRANSFORM_EFFECT: PrimitiveColorTransformEffects = {
  preset: 'primitive_color_transform',
  transform: 'grayscale_to_color_base',
  base_filter: 'grayscale(100%) contrast(1.08)',
}

export const DEFAULT_PRIMITIVE_MASK_REVEAL_EFFECT: PrimitiveMaskRevealEffects = {
...
export const DEFAULT_PRIMITIVE_RING_OVERLAY_EFFECT: PrimitiveRingOverlayEffects = {
  preset: 'primitive_ring_overlay',
  ring: DEFAULT_COLOR_PORTAL_EFFECT.ring!,
  mask: DEFAULT_PRIMITIVE_MASK_REVEAL_EFFECT.mask,
}

export const DEFAULT_CINEMATIC_SWEEP_EFFECT: CinematicLightSweepEffects = {
...
export const DEFAULT_RIPPLE_EFFECT: RippleDisplacementEffects = {
...
export const DEFAULT_KINETIC_COLOR_RIPPLE_EFFECT: KineticColorRippleEffects = {
...
export const DEFAULT_PRIMITIVE_ORB_MOTION_EFFECT: PrimitiveOrbMotionEffects = {
  preset: 'primitive_orb_motion',
  orb: DEFAULT_KINETIC_COLOR_RIPPLE_EFFECT.orb,
}

export const DEFAULT_PRIMITIVE_ORB_RING_OVERLAY_EFFECT: PrimitiveOrbRingOverlayEffects = {
  preset: 'primitive_orb_ring_overlay',
  orb: DEFAULT_KINETIC_COLOR_RIPPLE_EFFECT.orb,
  ring: DEFAULT_KINETIC_COLOR_RIPPLE_EFFECT.ring!,
}

export const DEFAULT_PRIMITIVE_DIRECTIONAL_WAVE_REVEAL_EFFECT: PrimitiveDirectionalWaveRevealEffects = {
...
export const DEFAULT_EDITORIAL_SPLIT_COLLAGE_EFFECT: EditorialSplitCollageEffects = {
...
export const DEFAULT_CINEMATIC_GRADE_PACK_EFFECT: CinematicGradePackEffects = {
...
export const DEFAULT_AUDIO_REACTIVE_CUT_DRIVER_EFFECT: AudioReactiveCutDriverEffects = {
...
export const DEFAULT_MASK_SLICE_TRANSITION_EFFECT: MaskSliceTransitionEffects = {
...
export const DEFAULT_PRIMITIVE_TEXTURE_GRADE_EFFECT: PrimitiveTextureGradeEffects = {
...
export const DEFAULT_PRIMITIVE_BLOOM_OVERLAY_EFFECT: PrimitiveBloomOverlayEffects = {
  preset: 'primitive_bloom_overlay',
  bloom: DEFAULT_CINEMATIC_GRADE_PACK_EFFECT.bloom!,
}

export const DEFAULT_PRIMITIVE_VIGNETTE_OVERLAY_EFFECT: PrimitiveVignetteOverlayEffects = {
  preset: 'primitive_vignette_overlay',
  vignette: DEFAULT_CINEMATIC_GRADE_PACK_EFFECT.vignette!,
}

export const DEFAULT_PRIMITIVE_GRAIN_OVERLAY_EFFECT: PrimitiveGrainOverlayEffects = {
  preset: 'primitive_grain_overlay',
  grain: DEFAULT_CINEMATIC_GRADE_PACK_EFFECT.grain!,
}

export const DEFAULT_PRIMITIVE_LETTERBOX_OVERLAY_EFFECT: PrimitiveLetterboxOverlayEffects = {
  preset: 'primitive_letterbox_overlay',
  letterbox: DEFAULT_CINEMATIC_GRADE_PACK_EFFECT.letterbox!,
}

export const DEFAULT_PRIMITIVE_CHROMATIC_ABERRATION_OVERLAY_EFFECT: PrimitiveChromaticAberrationOverlayEffects =
  {
...
export const DEFAULT_PRIMITIVE_LIGHT_SWEEP_OVERLAY_EFFECT: PrimitiveLightSweepOverlayEffects = {
  preset: 'primitive_light_sweep_overlay',
  sweep: DEFAULT_CINEMATIC_SWEEP_EFFECT.sweep,
}

export const DEFAULT_PRIMITIVE_BEAT_PULSE_EFFECT: PrimitiveBeatPulseEffects = {
...
export const DEFAULT_PRIMITIVE_BEAT_FLASH_OVERLAY_EFFECT: PrimitiveBeatFlashOverlayEffects = {
...
export const DEFAULT_PRIMITIVE_BEAT_COLOR_UNLOCK_EFFECT: PrimitiveBeatColorUnlockEffects = {
...
export const DEFAULT_PRIMITIVE_COLOR_HINT_OVERLAY_EFFECT: PrimitiveColorHintOverlayEffects = {
...
export const DEFAULT_PRIMITIVE_FADE_OVERLAY_EFFECT: PrimitiveFadeOverlayEffects = {
...
export const DEFAULT_PRIMITIVE_TRANSITION_ACCENT_OVERLAY_EFFECT: PrimitiveTransitionAccentOverlayEffects = {
...
export const DEFAULT_PRIMITIVE_SLICE_REVEAL_EFFECT: PrimitiveSliceRevealEffects = {
...
export const DEFAULT_PRIMITIVE_RIPPLE_DISPLACEMENT_EFFECT: PrimitiveRippleDisplacementEffects = {
  preset: 'primitive_ripple_displacement',
  ripple: DEFAULT_RIPPLE_EFFECT.ripple,
}

export const DEFAULT_PRIMITIVE_RIPPLE_RING_OVERLAY_EFFECT: PrimitiveRippleRingOverlayEffects = {
  preset: 'primitive_ripple_ring_overlay',
  ripple: DEFAULT_RIPPLE_EFFECT.ripple,
  lighting: DEFAULT_RIPPLE_EFFECT.lighting,
}

export const DEFAULT_PRIMITIVE_COLLAGE_LAYOUT_EFFECT: PrimitiveCollageLayoutEffects = {
...
export const EFFECT_PRESET_REGISTRY: EffectPresetDefinition[] = [
  {
  ...
  },
  {
    ...
    description:
      'Beat and energy timing driver that adds pulse zoom, flash, and shake to clips.',
    supportedAssetTypes: ['image', 'video', 'generated_video'],
  ...
  },
  {
    ...
    description:
      'Reusable film grade layer with vignette, grain, letterbox, bloom, and chromatic edges.',
    supportedAssetTypes: ['image', 'video', 'generated_video'],
  ...
  },
  {
    ...
    description:
      'Horizontal or vertical masked slices with staggered slide motion and chromatic edges.',
    supportedAssetTypes: ['image', 'video', 'generated_video'],
  ...
  },
  {
    ...
    description:
      'Cinematic landscape base with horizontal slice panels, vertical triptych panels, vignette, grain, and subtle chromatic edges.',
    supportedAssetTypes: ['image', 'video', 'generated_video'],
  ...
  },
  {
    ...
    description:
      'A glowing orb drives a lagging neon ring and directional ripple waves that unlock color from black-and-white footage.',
    supportedAssetTypes: ['image', 'video', 'generated_video'],
...
export function getEffectPresetDefinition(
  preset: string | undefined,
): EffectPresetDefinition | undefined {
  return EFFECT_PRESET_REGISTRY.find((item) => item.id === preset)
}

export function createDefaultEffect(preset: EffectPresetId): SceneEffects | undefined {
  const definition = getEffectPresetDefinition(preset)
  if (!definition) return undefined
  return structuredClone(definition.defaultEffect)
}

export function isKnownEffectPreset(preset: string | undefined): preset is EffectPresetId {
