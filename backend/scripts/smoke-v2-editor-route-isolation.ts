...
assert.doesNotMatch(timelinePanel, /hasV2Sample|样例解析/)

const editableTimeline = source('fonted/src/components/timeline/EditableTimeline.tsx')
assert.doesNotMatch(editableTimeline, /V2SampleTimeline/)
...
assert.doesNotMatch(migrationCanvas, /V2SamplePlayer/)
...
assert.equal(existsSync(resolve(root, 'fonted/src/lib/v2-sample-ui.ts')), false)
assert.equal(existsSync(resolve(root, 'fonted/src/components/canvas/V2SamplePlayer.tsx')), false)
assert.equal(existsSync(resolve(root, 'fonted/src/components/layout/V2SamplePropertyInspector.tsx')), false)
assert.equal(existsSync(resolve(root, 'fonted/src/components/timeline/V2SampleTimeline.tsx')), false)
